//
//  AjoutAmbulancierViewController.swift
//  Ambulance
//
...
class AjoutAmbulancierViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource  {
    ...
    @IBOutlet weak var view_end_editing: UIView!
    ...
    override func viewDidLoad() {
        ...
        view_end_editing.addGestureRecognizer(tap)
        view_end_editing.removeGestureRecognizer(tap)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        DispatchQueue.main.async {
            ...
            if(self.tbl_dep.isHidden == true){
                ...
                self.view_end_editing.addGestureRecognizer(self.tap)
...
//        self.present(newViewController, animated: false, completion: nil)
    ...
    func ajouter_ambulancier(){
        ...
        let url = NSURL(string:"\(web_url)/ambilancier/ajout")
            ...
            do
            {
                if let json = try JSONSerialization.jsonObject(with: data!, options: JSONSerialization.ReadingOptions.mutableContainers) as? NSDictionary{
                    ...
                    DispatchQueue.main.async {
                        ...
                        let alert = UIAlertController(title: "Succès", message: "\(self.txt_nomAmbcier.text!) est ajouté", preferredStyle: .alert)
                        ...
                        self.txt_cmdp.text = ""
                            ...
                            let alert = UIAlertController(title: "Erreur", message: "l'ajout est echoué", preferredStyle: .alert)
    ...
    @IBAction func butt_down_reg(_ sender: Any) {
        tbl_dep.isHidden = true
DispatchQueue.main.async {
    self.view_end_editing.endEditing(true)
    self.view_end_editing.removeGestureRecognizer(self.tap)
